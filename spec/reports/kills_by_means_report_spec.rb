...
describe KillsByMeansReport do
  describe '#report_content' do
    ...
    it 'selects key :kills_by_means from game' do
      expected = {
        game_id => game[game_id].select { |k| k == :kills_by_means }
      }
  ...
  describe '.report_name' do
    ...
    it 'returns report name' do
      expect(subject).to include('kills_by_means_report')
    end
  end
end
